...
*** Font
    ...
    <2022-01-06 Thu> You know what?  bitmap fonts are cool, so I'm
    using the xterm default one (on OpenBSD) for *everything*!

    #+begin_src emacs-lisp
      ;; Iosevka Term Curly Medium 9
      (let ((font "-misc-fixed-medium-r-semicondensed--13-120-75-75-c-60-iso10646-1"))
        (add-to-list 'default-frame-alist `(font . ,font))
        (set-face-attribute 'variable-pitch t :font font)
        (set-face-attribute 'variable-pitch nil :font font)
        (set-face-attribute 'fixed-pitch t :font font)
     ...
     #+begin_src emacs-lisp
       (use-package emacs
         ...
         :custom ((message-default-charset 'utf8)
                  ...
                  (mu4e-get-mail-command "cmdseq 10 \"mbsync op\" 1 \"mbsync -a\"")
